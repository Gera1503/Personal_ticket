<?php
    class Usuario extends Conectar{
        ...
        $contrasena_encriptada=base64_encode($iv . $cifrado);
            $conectar= parent::Conexion();
            parent::set_names();
            $sql="INSERT INTO tm_usuario (usu_id, usu_nom, usu_ape, usu_correo, usu_pass, rol_id, edit, fech_crea, fech_modi, fech_elim, est) VALUES (NULL, ?, ?, ?, ?,?,NULL, now(), NULL, NULL, '1')";
